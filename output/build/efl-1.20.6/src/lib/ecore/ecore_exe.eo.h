...
typedef enum
{
  ...
  ECORE_EXE_NOT_LEADER = 256, /**< Do not use setsid() to have the executed
                               * process be its own session leader */
 ...
 * processes. An interaction between your process and those spawned is possible
