...
Efl_Object *_elm_view_form_efl_object_constructor(Eo *obj, Elm_View_Form_Data *pd);
...
#define ELM_VIEW_FORM_EXTRA_OPS
   ...
   EFL_OPS_DEFINE(ops,
      ...
      EFL_OBJECT_OP_FUNC(efl_constructor, _elm_view_form_efl_object_constructor),
      ELM_VIEW_FORM_EXTRA_OPS
   );
   opsp = &ops;

#ifdef ELM_VIEW_FORM_EXTRA_CLASS_OPS
   EFL_OPS_DEFINE(cops, ELM_VIEW_FORM_EXTRA_CLASS_OPS);
   copsp = &cops;
#endif
