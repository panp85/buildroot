 ...
 * scroller view.
 *
 * See @ref elm_obj_map_zoom_mode_set() See @ref elm_obj_map_zoom_mode_get()
 *
 * @ingroup Elm_Map
 */
typedef enum
 ...
 * @ingroup Elm_Map
 */
EOAPI void elm_obj_map_zoom_set(Eo *obj, int zoom);
 ...
 * @ingroup Elm_Map
 */
EOAPI int elm_obj_map_zoom_get(const Eo *obj);
 ...
 * @ingroup Elm_Map
 */
EOAPI void elm_obj_map_paused_set(Eo *obj, Eina_Bool paused);
 ...
 * @ingroup Elm_Map
 */
EOAPI Eina_Bool elm_obj_map_paused_get(const Eo *obj);
 ...
 * @ingroup Elm_Map
 */
EOAPI void elm_obj_map_wheel_disabled_set(Eo *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Map
 */
EOAPI Eina_Bool elm_obj_map_wheel_disabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Map
 */
EOAPI void elm_obj_map_zoom_mode_set(Eo *obj, Elm_Map_Zoom_Mode mode);
 ...
 * @ingroup Elm_Map
 */
EOAPI Elm_Map_Zoom_Mode elm_obj_map_zoom_mode_get(const Eo *obj);
...
EWAPI extern const Efl_Event_Description _ELM_MAP_EVENT_ZOOM_CHANGE;

/** Called when map zoom changed
 *
 * @ingroup Elm_Map
 */
