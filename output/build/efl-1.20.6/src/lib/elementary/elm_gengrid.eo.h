 ...
 * @ingroup Elm_Gengrid
 */
EOAPI void elm_obj_gengrid_page_relative_set(Eo *obj, double h_pagerel, double v_pagerel);
 ...
 * @ingroup Elm_Gengrid
 */
EOAPI void elm_obj_gengrid_page_relative_get(const Eo *obj, double *h_pagerel, double *v_pagerel);
 ...
 * @ingroup Elm_Gengrid
 */
EOAPI void elm_obj_gengrid_page_size_set(Eo *obj, int h_pagesize, int v_pagesize);
 ...
 * @ingroup Elm_Gengrid
 */
EOAPI void elm_obj_gengrid_wheel_disabled_set(Eo *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Gengrid
 */
EOAPI Eina_Bool elm_obj_gengrid_wheel_disabled_get(const Eo *obj);
