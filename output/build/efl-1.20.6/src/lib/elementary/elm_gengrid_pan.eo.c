...
void _elm_gengrid_pan_efl_gfx_position_set(Eo *obj, Elm_Gengrid_Pan_Data *pd, int x, int y);


void _elm_gengrid_pan_efl_gfx_size_set(Eo *obj, Elm_Gengrid_Pan_Data *pd, int w, int h);


void _elm_gengrid_pan_efl_canvas_group_group_calculate(Eo *obj, Elm_Gengrid_Pan_Data *pd);


void _elm_gengrid_pan_elm_pan_content_size_get(Eo *obj, Elm_Gengrid_Pan_Data *pd, int *w, int *h);


void _elm_gengrid_pan_elm_pan_pos_set(Eo *obj, Elm_Gengrid_Pan_Data *pd, int x, int y);


void _elm_gengrid_pan_elm_pan_pos_get(Eo *obj, Elm_Gengrid_Pan_Data *pd, int *x, int *y);


void _elm_gengrid_pan_elm_pan_pos_min_get(Eo *obj, Elm_Gengrid_Pan_Data *pd, int *x, int *y);


void _elm_gengrid_pan_elm_pan_pos_max_get(Eo *obj, Elm_Gengrid_Pan_Data *pd, int *x, int *y);
...
#define ELM_GENGRID_PAN_EXTRA_OPS
   ...
   EFL_OPS_DEFINE(ops,
      ...
      EFL_OBJECT_OP_FUNC(efl_gfx_position_set, _elm_gengrid_pan_efl_gfx_position_set),
      EFL_OBJECT_OP_FUNC(efl_gfx_size_set, _elm_gengrid_pan_efl_gfx_size_set),
...
#ifdef ELM_GENGRID_PAN_EXTRA_CLASS_OPS
   EFL_OPS_DEFINE(cops, ELM_GENGRID_PAN_EXTRA_CLASS_OPS);
   copsp = &cops;
#endif
