 ...
 * @ingroup Evas_Canvas
 */
EOAPI Eina_Bool evas_canvas_pointer_inside_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EOAPI Eina_List *evas_canvas_objects_at_xy_get(const Eo *obj, int x, int y, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EOAPI Eina_List *evas_canvas_render2_updates(Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EOAPI Efl_Canvas_Object *evas_canvas_object_top_at_xy_get(const Eo *obj, int x, int y, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EOAPI Eina_List *evas_canvas_objects_in_rectangle_get(const Eo *obj, int x, int y, int w, int h, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EOAPI Efl_Canvas_Object *evas_canvas_object_top_in_rectangle_get(const Eo *obj, int x, int y, int w, int h, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
