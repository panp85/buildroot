...
cp -p /media/panpan/tools/buildroot-2018.02.8/output/build/libgtk2-2.24.31/COPYING share/doc/gtk+-2.24.31

mkdir -p share/doc/gtk+-dev-2.24.31
cp -p /media/panpan/tools/buildroot-2018.02.8/output/build/libgtk2-2.24.31/COPYING share/doc/gtk+-dev-2.24.31
