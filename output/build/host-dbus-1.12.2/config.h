...
#define DBUS_BINDIR "/media/panpan/tools/buildroot-2018.02.8/output/host/bin"
...
#define DBUS_DAEMONDIR "/media/panpan/tools/buildroot-2018.02.8/output/host/bin"

/* Name of executable */
#define DBUS_DAEMON_NAME "dbus-daemon"

/* Directory for installing DBUS data files */
#define DBUS_DATADIR "/media/panpan/tools/buildroot-2018.02.8/output/host/share"
...
#define DBUS_LIBEXECDIR "/media/panpan/tools/buildroot-2018.02.8/output/host/libexec"

/* Prefix for installing DBUS */
#define DBUS_PREFIX "/media/panpan/tools/buildroot-2018.02.8/output/host"
...
#define DBUS_SYSTEM_BUS_DEFAULT_ADDRESS "unix:path=/media/panpan/tools/buildroot-2018.02.8/output/host/var/run/dbus/system_bus_socket"

/* The name of the socket the system bus listens on by default */
#define DBUS_SYSTEM_SOCKET "/media/panpan/tools/buildroot-2018.02.8/output/host/var/run/dbus/system_bus_socket"

/* Full path to the launch helper test program in the builddir */
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/media/panpan/tools/buildroot-2018.02.8/output/build/host-dbus-1.12.2/bus/dbus-daemon-launch-helper-test"
...
#define PACKAGE_STRING "dbus 1.12.2"
