...
(*.[0-9]*)
	...
	if test ! -f /media/panpan/tools/buildroot-2018.02.8/output/build/ncurses-6.0/man_alias.sed ; then
cat >>/media/panpan/tools/buildroot-2018.02.8/output/build/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /media/panpan/tools/buildroot-2018.02.8/output/build/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /media/panpan/tools/buildroot-2018.02.8/output/build/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /media/panpan/tools/buildroot-2018.02.8/output/build/ncurses-6.0/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /media/panpan/tools/buildroot-2018.02.8/output/build/ncurses-6.0/man_alias.sed \
		< $i | sed -f /media/panpan/tools/buildroot-2018.02.8/output/build/ncurses-6.0/edit_man.sed >$TMP
