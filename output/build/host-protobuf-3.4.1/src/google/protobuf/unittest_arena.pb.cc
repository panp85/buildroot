...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(NestedMessage)},
  { 7, 14, sizeof(ArenaMessage)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _NestedMessage_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_NestedMessage_default_instance_);_ArenaMessage_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ArenaMessage_default_instance_);}
