...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(TestMessageSetContainer)},
  { 7, 13, sizeof(TestMessageSetExtension1)},
  { 14, 20, sizeof(TestMessageSetExtension2)},
  { 21, 28, sizeof(RawMessageSet_Item)},
  { 30, 36, sizeof(RawMessageSet)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TestMessageSetContainer_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestMessageSetContainer_default_instance_);_TestMessageSetExtension1_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestMessageSetExtension1_default_instance_);_TestMessageSetExtension2_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestMessageSetExtension2_default_instance_);_RawMessageSet_Item_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RawMessageSet_Item_default_instance_);_RawMessageSet_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RawMessageSet_default_instance_);::google::protobuf::internal::ExtensionSet::RegisterMessageExtension(
  ...
  _TestMessageSetContainer_default_instance_._instance.get_mutable()->message_set_ = const_cast< ::proto2_wireformat_unittest::TestMessageSet*>(
      ::proto2_wireformat_unittest::TestMessageSet::internal_default_instance());
}
...
#if LANG_CXX11
void TestMessageSetExtension2::set_str(::std::string&& value) {
  set_has_str();
  str_.Set(
...
#if LANG_CXX11
void RawMessageSet_Item::set_message(::std::string&& value) {
  set_has_message();
  message_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
