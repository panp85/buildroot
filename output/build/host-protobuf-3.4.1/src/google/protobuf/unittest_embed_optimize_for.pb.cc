...
void TableStruct::InitDefaultsImpl() {
  ...
  _TestEmbedOptimizedForSize_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestEmbedOptimizedForSize_default_instance_);_TestEmbedOptimizedForSize_default_instance_._instance.get_mutable()->optional_message_ = const_cast< ::protobuf_unittest::TestOptimizedForSize*>(
