...
void TableStruct::InitDefaultsImpl() {
  ...
  _TestAny_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestAny_default_instance_);_TestAny_default_instance_._instance.get_mutable()->any_value_ = const_cast< ::google::protobuf::Any*>(
