...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, sizeof(TestField)},
  { 15, 26, sizeof(TestDiffMessage_Item)},
  { 32, 44, sizeof(TestDiffMessage)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TestField_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestField_default_instance_);_TestDiffMessage_Item_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestDiffMessage_Item_default_instance_);_TestDiffMessage_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestDiffMessage_default_instance_);::google::protobuf::internal::ExtensionSet::RegisterMessageExtension(
    ::protobuf_unittest::TestDiffMessage::internal_default_instance(),
    100, 11, false, false,
    ::protobuf_unittest::TestField::internal_default_instance());
  _TestField_default_instance_._instance.get_mutable()->m_ = const_cast< ::protobuf_unittest::TestField*>(
      ::protobuf_unittest::TestField::internal_default_instance());
  _TestDiffMessage_Item_default_instance_._instance.get_mutable()->m_ = const_cast< ::protobuf_unittest::TestField*>(
      ::protobuf_unittest::TestField::internal_default_instance());
  _TestDiffMessage_default_instance_._instance.get_mutable()->m_ = const_cast< ::protobuf_unittest::TestField*>(
      ::protobuf_unittest::TestField::internal_default_instance());
}
...
#if LANG_CXX11
void TestDiffMessage_Item::set_rb(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:protobuf_unittest.TestDiffMessage.Item.rb)
...
#if LANG_CXX11
void TestDiffMessage_Item::add_rb(::std::string&& value) {
...
#if LANG_CXX11
void TestDiffMessage::set_rw(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:protobuf_unittest.TestDiffMessage.rw)
...
#if LANG_CXX11
void TestDiffMessage::add_rw(::std::string&& value) {
