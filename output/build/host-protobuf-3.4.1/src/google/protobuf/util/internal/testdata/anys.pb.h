...
class Data_MapDataEntry;
class Data_MapDataEntryDefaultTypeInternal;
extern Data_MapDataEntryDefaultTypeInternal _Data_MapDataEntry_default_instance_;
class Imports;
...
class Data : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.protobuf.testing.Data) */ {
 ...
 private:
  ...
  public:
  class Data_MapDataEntry : public ::google::protobuf::internal::MapEntry<Data_MapDataEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Data_MapDataEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    Data_MapDataEntry();
    Data_MapDataEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Data_MapDataEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Data_MapDataEntry_default_instance_); }
