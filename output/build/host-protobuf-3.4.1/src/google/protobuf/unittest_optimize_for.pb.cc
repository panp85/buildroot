...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(TestOptimizedForSizeDefaultTypeInternal, integer_field_),
  offsetof(TestOptimizedForSizeDefaultTypeInternal, string_field_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, sizeof(TestOptimizedForSize)},
  { 14, 20, sizeof(TestRequiredOptimizedForSize)},
  { 21, 27, sizeof(TestOptionalOptimizedForSize)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TestOptimizedForSize_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestOptimizedForSize_default_instance_);_TestRequiredOptimizedForSize_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestRequiredOptimizedForSize_default_instance_);_TestOptionalOptimizedForSize_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TestOptionalOptimizedForSize_default_instance_);::google::protobuf::internal::ExtensionSet::RegisterExtension(
  ...
  _TestOptimizedForSize_default_instance_._instance.get_mutable()->msg_ = const_cast< ::protobuf_unittest::ForeignMessage*>(
  ...
  _TestOptionalOptimizedForSize_default_instance_._instance.get_mutable()->o_ = const_cast< ::protobuf_unittest::TestRequiredOptimizedForSize*>(
      ::protobuf_unittest::TestRequiredOptimizedForSize::internal_default_instance());
}
