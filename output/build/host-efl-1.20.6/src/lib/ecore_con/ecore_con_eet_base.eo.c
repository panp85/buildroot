...
Ecore_Con_Server *_ecore_con_eet_base_server_get(Eo *obj, Ecore_Con_Eet_Base_Data *pd);
...
void _ecore_con_eet_base_raw_send(Eo *obj, Ecore_Con_Eet_Base_Data *pd, Ecore_Con_Reply *reply, const char *protocol_name, const char *section, void *value, unsigned int length);

EOAPI EFL_VOID_FUNC_BODYV(ecore_con_eet_base_raw_send, EFL_FUNC_CALL(reply, protocol_name, section, value, length), Ecore_Con_Reply *reply, const char *protocol_name, const char *section, void *value, unsigned int length);
...
#ifdef ECORE_CON_EET_BASE_EXTRA_CLASS_OPS
   EFL_OPS_DEFINE(cops, ECORE_CON_EET_BASE_EXTRA_CLASS_OPS);
   copsp = &cops;
#endif
