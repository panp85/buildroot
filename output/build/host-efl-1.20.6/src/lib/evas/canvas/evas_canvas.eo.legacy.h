 ...
 * @ingroup Evas_Canvas
 */
EAPI Eina_Bool evas_pointer_inside_by_device_get(const Evas_Canvas *obj, Efl_Input_Device * dev);
 ...
 * height.
 *
 * @return @c true if it can handle the maximum image size, @c false otherwise
 *
 * @since 1.1
 *
 * @ingroup Evas_Canvas
 ...
 * @ingroup Evas_Canvas
 */
EAPI Eina_List *evas_objects_at_xy_get(const Evas_Canvas *obj, int x, int y, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EAPI Efl_Canvas_Object *evas_object_top_at_xy_get(const Evas_Canvas *obj, int x, int y, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EAPI Eina_List *evas_objects_in_rectangle_get(const Evas_Canvas *obj, int x, int y, int w, int h, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EAPI Eina_Bool evas_smart_objects_calculating_get(const Evas_Canvas *obj);
 ...
 * @ingroup Evas_Canvas
 */
EAPI Efl_Canvas_Object *evas_object_top_in_rectangle_get(const Evas_Canvas *obj, int x, int y, int w, int h, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
