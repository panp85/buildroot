 ...
 *
 * See also @ref elm_obj_entry_cnp_mode_set, @ref elm_obj_entry_cnp_mode_get.
 *
 * @ingroup Elm
 */
typedef enum
 ...
 * @ingroup Elm_Entry
 */
EOAPI Eina_Bool elm_obj_entry_cursor_geometry_get(const Eo *obj, int *x, int *y, int *w, int *h);
 ...
 * @ingroup Elm_Entry
 */
EOAPI char *elm_obj_entry_cursor_content_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Entry
 */
EOAPI void elm_obj_entry_calc_force(Eo *obj);
