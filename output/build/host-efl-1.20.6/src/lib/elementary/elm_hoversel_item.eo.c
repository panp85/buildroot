...
void _elm_hoversel_item_icon_get(Eo *obj, Elm_Hoversel_Item_Data *pd, const char **icon_file, const char **icon_group, Elm_Icon_Type *icon_type);
...
const char *_elm_hoversel_item_elm_widget_item_part_text_get(Eo *obj, Elm_Hoversel_Item_Data *pd, const char *part);


void _elm_hoversel_item_elm_widget_item_style_set(Eo *obj, Elm_Hoversel_Item_Data *pd, const char *style);


const char *_elm_hoversel_item_elm_widget_item_style_get(Eo *obj, Elm_Hoversel_Item_Data *pd);


void _elm_hoversel_item_elm_widget_item_focus_set(Eo *obj, Elm_Hoversel_Item_Data *pd, Eina_Bool focused);


Eina_Bool _elm_hoversel_item_elm_widget_item_focus_get(Eo *obj, Elm_Hoversel_Item_Data *pd);
...
#define ELM_HOVERSEL_ITEM_EXTRA_OPS
   ...
   EFL_OPS_DEFINE(ops,
      ...
      EFL_OBJECT_OP_FUNC(elm_wdg_item_focus_set, _elm_hoversel_item_elm_widget_item_focus_set),
      EFL_OBJECT_OP_FUNC(elm_wdg_item_focus_get, _elm_hoversel_item_elm_widget_item_focus_get),
      ELM_HOVERSEL_ITEM_EXTRA_OPS
   );
   opsp = &ops;

#ifdef ELM_HOVERSEL_ITEM_EXTRA_CLASS_OPS
   EFL_OPS_DEFINE(cops, ELM_HOVERSEL_ITEM_EXTRA_CLASS_OPS);
   copsp = &cops;
#endif
...
EFL_DEFINE_CLASS(elm_hoversel_item_class_get, &_elm_hoversel_item_class_desc, ELM_WIDGET_ITEM_CLASS, NULL);
