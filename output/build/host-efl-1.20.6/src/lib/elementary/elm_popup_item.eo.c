...
const char *_elm_popup_item_elm_widget_item_part_text_get(Eo *obj, Elm_Popup_Item_Data *pd, const char *part);
...
Efl_Canvas_Object *_elm_popup_item_elm_widget_item_part_content_get(Eo *obj, Elm_Popup_Item_Data *pd, const char *part);
...
#ifdef ELM_POPUP_ITEM_EXTRA_CLASS_OPS
   EFL_OPS_DEFINE(cops, ELM_POPUP_ITEM_EXTRA_CLASS_OPS);
   copsp = &cops;
#endif
...
EFL_DEFINE_CLASS(elm_popup_item_class_get, &_elm_popup_item_class_desc, ELM_WIDGET_ITEM_CLASS, NULL);
