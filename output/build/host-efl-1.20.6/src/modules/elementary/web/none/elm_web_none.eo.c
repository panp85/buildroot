...
Efl_Canvas_Object *_elm_web_none_elm_web_webkit_view_get(Eo *obj, Elm_Web_None_Data *pd);
...
#define ELM_WEB_NONE_EXTRA_OPS
   ...
   EFL_OPS_DEFINE(ops,
      ...
      EFL_OBJECT_OP_FUNC(elm_obj_web_zoom_set, _elm_web_none_elm_web_zoom_set),
      EFL_OBJECT_OP_FUNC(elm_obj_web_zoom_get, _elm_web_none_elm_web_zoom_get),
      EFL_OBJECT_OP_FUNC(elm_obj_web_zoom_mode_set, _elm_web_none_elm_web_zoom_mode_set),
      EFL_OBJECT_OP_FUNC(elm_obj_web_zoom_mode_get, _elm_web_none_elm_web_zoom_mode_get),
...
#ifdef ELM_WEB_NONE_EXTRA_CLASS_OPS
   EFL_OPS_DEFINE(cops, ELM_WEB_NONE_EXTRA_CLASS_OPS);
   copsp = &cops;
#endif
...
EFL_DEFINE_CLASS(elm_web_none_class_get, &_elm_web_none_class_desc, ELM_WEB_CLASS, NULL);
