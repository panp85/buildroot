...
static PyUFuncGenericFunction divmod_functions[] = {BYTE_divmod, UBYTE_divmod, SHORT_divmod, USHORT_divmod, INT_divmod, UINT_divmod, LONG_divmod, ULONG_divmod, LONGLONG_divmod, ULONGLONG_divmod, HALF_divmod, FLOAT_divmod, DOUBLE_divmod, LONGDOUBLE_divmod, NULL};
...
InitOperators(PyObject *dictionary) {
    ...
    divmod_functions[14] = PyUFunc_OO_O;
    divmod_data[14] = (void *) PyNumber_Divmod;
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_SUPPORTS_AVX2) {
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(divmod_functions, divmod_data, divmod_signatures, 15,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(float_power_functions, float_power_data, float_power_signatures, 4,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(heaviside_functions, heaviside_data, heaviside_signatures, 4,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(isnat_functions, isnat_data, isnat_signatures, 2,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(positive_functions, positive_data, positive_signatures, 19,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(true_divide_functions, true_divide_data, true_divide_signatures, 11,
