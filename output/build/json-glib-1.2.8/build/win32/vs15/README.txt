...
This VS15 solution and the projects it includes are intended to be used
...
<root>\json-glib\<this-json-glib-source-tree>\build\win32\vs15\README.
...
instructions in <root>\glib<-version>\build\win32\vs15, so that the required
...
<root>\vs15\<PlatformName>\lib and JSON-GLib headers into
<root>\vs15\<PlatformName>\include\json-glib-1.0. This is then from where
