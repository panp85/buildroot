 ...
 * @c item in the list.
 *
 * Also the next item means item in the same tree level. If a item has
 * subitems, and it have expand all subitems will be ignore, and will get the
 * next item in the same level.
 *
 ...
 * @ingroup Elm_Genlist_Item
 */
EOAPI Elm_Widget_Item *elm_obj_genlist_item_parent_get(const Eo *obj);
