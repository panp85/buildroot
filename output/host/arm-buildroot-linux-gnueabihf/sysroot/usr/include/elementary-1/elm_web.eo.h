 ...
 * @ingroup Elm_Web
 */
EOAPI void elm_obj_web_zoom_mode_set(Eo *obj, Elm_Web_Zoom_Mode mode);
 ...
 * @ingroup Elm_Web
 */
EOAPI Elm_Web_Zoom_Mode elm_obj_web_zoom_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
EOAPI void elm_obj_web_zoom_set(Eo *obj, double zoom);
 ...
 * @ingroup Elm_Web
 */
EOAPI double elm_obj_web_zoom_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
EOAPI const char *elm_obj_web_selection_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Web
 */
EOAPI const char *elm_obj_web_title_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
...
EWAPI extern const Efl_Event_Description _ELM_WEB_EVENT_URI_CHANGED;
...
EWAPI extern const Efl_Event_Description _ELM_WEB_EVENT_URL_CHANGED;
...
EWAPI extern const Efl_Event_Description _ELM_WEB_EVENT_WINDOWS_CLOSE_REQUEST;

/** Called when window closed event was received
 *
 * @ingroup Elm_Web
 */
