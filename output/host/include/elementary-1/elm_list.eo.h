...
typedef enum
{
  ...
  ELM_LIST_EXPAND, /**< Besides setting a minimum size on the transverse axis,
                    ...
                    * minimum size on th longitudinal axis, trying to reserve
...
EWAPI extern const Efl_Event_Description _ELM_LIST_EVENT_ITEM_REORDER_ANIM_START;
...
EWAPI extern const Efl_Event_Description _ELM_LIST_EVENT_ITEM_REORDER_ANIM_STOP;
